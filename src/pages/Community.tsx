...
import { MessageCircle, Heart, Share2, Users, Plus, Search, Clock, Image, X, ThumbsUp } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          {activeTab === 'posts' && (
            <>
              {/* Search Bar */}
              <Card className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl">
              ...
              <Card className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl">
                <CardHeader>
                  <CardTitle className="text-white">নতুন পোস্ট লিখুন</CardTitle>
                </CardHeader>
              ...
              {filteredPosts.map((post) => (
                <Card key={post.id} className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl">
          ...
          {activeTab === 'groups' && (
            <Card className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl">
              <CardContent className="p-12 text-center">
                ...
                <h3 className="text-white text-xl font-semibold mb-2">Study Group আসছে শীঘ্রই</h3>
                <p className="text-gray-400">বন্ধুদের সাথে গ্রুপ তৈরি করে একসাথে পড়াশোনা করুন</p>
              </CardContent>
            </Card>
          )}
        </div>
